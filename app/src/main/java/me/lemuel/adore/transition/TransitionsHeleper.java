package me.lemuel.adore.transition;
...
import me.lemuel.adore.transition.method.NoneShowMethod;
import me.lemuel.adore.transition.method.ShowMethod;
import me.lemuel.adore.transition.view.CirleAnimView;
...
public class TransitionsHeleper {
    ...
    public void show(final Activity activity, final SimpleDraweeView targetView) {
        ...
        parent.post(new Runnable() {
            ...
            public void run() {
                ...
                final SimpleDraweeView ivTemp = new SimpleDraweeView(activity);
                if (bean.bitmap != null) {
